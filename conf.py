...
BLOG_AUTHOR = "JH Korridor"  # (translatable)
BLOG_TITLE = "Tuinfeest"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://tuinfeestbeerse.be/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://tuinfeestbeerse.be/"
BLOG_EMAIL = "info@tuinfeestbeerse.be"
BLOG_DESCRIPTION = "Tuinfeest Beerse"  # (translatable)
